    ...
    if(this.state.IsItemRequestActive === true)
    {
      return(
         <View style = {{flex:1,justifyContent:'center'}}>
            <View style = {{borderColor:'#4A148C',borderWidth:2,justifyContent:'center',alignItems:'center',padding:10,margin:10}}>
                <Text style = {{color:'#4A148C'}}>Item Name</Text>
                <Text style = {{color:'#4A148C'}}>{this.state.itemName}</Text>
            </View>
            <View style = {{borderColor:'#4A148C',borderWidth:2,justifyContent:'center',alignItems:'center',padding:10,margin:10}}>
                <Text style = {{color:'#4A148C'}}>Item Status</Text>
                <Text style = {{color:'#4A148C'}}>{this.state.itemStatus}</Text>
            </View>
            <TouchableOpacity
             style = {{borderWidth:1,borderColor:'#4A148C',backgroundColor:'#4A148C',width:300,alignSelf:'center',alignItems:'center',height:30,marginTop:30}}
             onPress = {() => {
            ...
            >
              <Text style = {{color:'#ffffff'}}>I recieved the item</Text>
            </TouchableOpacity>
         </View>
      )
    } 
